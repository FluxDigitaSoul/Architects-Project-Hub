...
- **AC-FR-M3-08-4 (precisione)** — *Dato* `Sp` = 10,01 mq e un'apertura con `Sa` = 1,251 mq; *allora* `SaMin = 1,25125` e l'esito è **Non conforme** (deficit −0,00025, mostrato come "−0,00 mq (valore esatto −0,00025)"). Il confronto non si fa sui valori arrotondati (`BR-22`).
